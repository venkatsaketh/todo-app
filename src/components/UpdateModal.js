...
const UpdateModal = ({ showModal, updateTodo, text }) => {
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className=" bg-gray-900 relative p-6 flex-auto">
              <input
                ...
                className="bg-gray-700 p-2 px-5 border border-gray-500 rounded-md focus:outline-none"
              />
            </div>
            {/*footer*/}
            <div className=" bg-gray-900 flex items-center justify-end p-6  border-solid border-slate-200 rounded-b">
              <button
